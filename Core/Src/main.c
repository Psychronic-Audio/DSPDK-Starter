...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(DAC_RESETn_GPIO_Port, DAC_RESETn_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_1_Pin|LED_2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : DAC_RESETn_Pin */
  GPIO_InitStruct.Pin = DAC_RESETn_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DAC_RESETn_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : FSWITCH_2_INT_Pin FSWITCH_1_INT_Pin */
  GPIO_InitStruct.Pin = FSWITCH_2_INT_Pin|FSWITCH_1_INT_Pin;
